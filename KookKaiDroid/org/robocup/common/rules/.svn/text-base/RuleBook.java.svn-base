...
public abstract class RuleBook {
	...
	private boolean penaltyTimeShown;
	...
	private boolean showLastSeenIndicator = false;
	...
	public boolean isShowLastSeenIndicator() {
		return showLastSeenIndicator;
	}

	public void setShowLastSeenIndicator(boolean showLastSeenIndicator) {
		this.showLastSeenIndicator = showLastSeenIndicator;
	}
	 ...
	 * @param time
	 *            the time how long a penalty is assign
	 */
	 ...
	 *            the time how long a penalty is assign
	 * @param isAddon
	 *            possibility to add more then one penalty
	 */
	 ...
	 * @param isAddon
	 *            possibility to add more then one penalty
	 * @param stayOnStateChange
	 *            penalty stay after gamestate change
	 */
	...
	public boolean getPenaltyTimeShown() {
		return penaltyTimeShown;
	}

	public void setPenaltyTimeShown(boolean val) {
		penaltyTimeShown = val;
	}
	...
	public void changePushingCounter(byte team, int count) {
		this.pushingCounter[team] = count;
	}	

...
public class GameStateVisualizer {
	public static void main(String args[]) {
		...
		for (int i = 0; i < args.length; ++i) {
			...
			} else if (Constants.ARG_HLADULT.equals(args[i])) {
				mode = Constants.MODE_HLADULT;
	...
	private static void usage() {
		...
		System.err.println("  -hlteen              Visualize Humanoid League Teen Size game state");
		System.err.println("  -hladult             Visualize Humanoid League Adult Size game state");

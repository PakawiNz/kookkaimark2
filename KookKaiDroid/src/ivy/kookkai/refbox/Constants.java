...
public class Constants {
	...
	public static final String ARG_HLADULT = "-hladult";
	...
	public static final String ARG_AUTOPAUSE = "-autopause";	
	...
	// game successor states
	public static final byte[] SUCC_STATE_INITIAL = {STATE_READY};
	public static final byte[] SUCC_STATE_READY = {STATE_SET};
	public static final byte[] SUCC_STATE_SET = {STATE_PLAYING};
	public static final byte[] SUCC_STATE_PLAYING = {STATE_READY, STATE_FINISHED};
	public static final byte[] SUCC_STATE_FINISHED = {STATE_INITIAL};
	
	// game successor states in penalty_mode
	public static final byte[] SUCC_STATE_PENALTY_INITIAL = {STATE_READY};		
	public static final byte[] SUCC_STATE_PENALTY_READY = {STATE_SET};	
	public static final byte[] SUCC_STATE_PENALTY_SET = {STATE_PLAYING};
	public static final byte[] SUCC_STATE_PENALTY_PLAYING = {STATE_FINISHED, STATE_SET};	
	public static final byte[] SUCC_STATE_PENALTY_FINISHED = {STATE_SET};
	...
	public static final String HELP = ""
			+ "Usage: java -jar GameController [-port p] [-range r] [-numplayers n] [-spl | -hlkid | -hlteen | -hladult] [-configdir dir] [-debug] [-autopause] [-broadcast broadcast_address] cyanTeamNumber magentaTeamNumber\n"
			+ "* The league type will default to spl if not specified.\n"
	...
	public static final int[] PLAYER_BUTTON_COLORS = { Color.GREEN, Color.YELLOW, Color.RED }; // in java color
	...
	public static final int[] LASTSEEN_INDICATOR_COLORS = { Color.RED, Color.YELLOW, Color.GREEN }; // in java color
	...
	public static final int MODE_HLADULT = 4;
